...
Il commença par le minimum vital. Le *bus factor*[^bus-factor] : combien de personnes doivent tomber pour qu'un service s'arrête. Si la réponse est un, c'est un problème — une maladie, des vacances, une démission, et plus personne ne sait faire tourner le truc. Deux, c'est le seuil. Le minimum pour que ça tienne.
...
[^bus-factor]: **Bus factor** : nombre minimum de personnes dont le départ soudain suffirait à paralyser un service.
