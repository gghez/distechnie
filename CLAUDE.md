...
The `/story <slug>` skill automates this: it loads the guidelines, shows the current status (chapters, WIP, draft entries), and prepares the session. Use it at the start of any writing session.
